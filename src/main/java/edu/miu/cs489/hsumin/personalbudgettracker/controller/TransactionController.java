...
public class TransactionController {
    ...
    private ResponseEntity<TransactionResponseDTO> createTransaction(@Valid @RequestBody TransactionRequestDTO transactionRequestDTO){
        ...
        return transactionResponseDTOr.map(transactionResponseDTO -> ResponseEntity.status(HttpStatus.CREATED).body(transactionResponseDTO))
    ...
    public List<TransactionResponseDTO> searchTransactions(
        ...
        // Adjust the service method to search using these parameters
